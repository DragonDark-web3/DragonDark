/**
 *Submitted for verification at polygonscan.com on 2023-03-15
*/
...
contract DragonDark is ReentrancyGuard {
 ...
 modifier onlyOwner {
    ...
    DEV_ADDRESS = 0xB775529d53f030585491Cb0f6047f3DA82F37b97;
    MARKETING_ADDRESS = 0x4481544D6E99A9c524cDb12215849a2528F77aa1;
    CEO_ADDRESS = 0xC1F11d8e888ADdfD07cF382c6740Cb4AE2bAa4E1;
    GIVEAWAY_ADDRESS = 0xC1F11d8e888ADdfD07cF382c6740Cb4AE2bAa4E1;
    ...
    _giveAway = payable(GIVEAWAY_ADDRESS);
        ...
        MIN_DEPOSIT = 10000000000000000; // 0.01 
        MIN_BAKE = 10000000000000000000; // 10 
 ...
 function user(address adr) public view returns (Baker memory) {
    ...
    function Dragonminer(address payable _token) public onlyOwner {
